                ...
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            ...
                            label="Post"
                            wire:model="comment.post_id"
                        >
                            <option value="null" disabled>Please select the Post</option>
                            @foreach($userPosts as $value => $label)
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.user_comments.inputs.content')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.user_comments.inputs.post_id')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.user_comments.inputs.score')
                    </th>
                    <th></th>
                </tr>
            </thead>
